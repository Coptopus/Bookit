...
class EditService extends StatefulWidget {
  final String docID;
  final dynamic data;
  const EditService({super.key, required this.docID, this.data});
...
class _EditServiceState extends State<EditService> {
  ...
  initializeData() {
    ...
    timed = widget.data['timed'];
    oneTime = widget.data['oneTime'];
    dateTime = widget.data['oneTimeDate'].toDate();
  ...
  editService() async {
    if (formState.currentState!.validate()) {
      try {
        if (imgName != null) {
          if (widget.data['img'] != "none") {
            FirebaseStorage.instance.refFromURL(widget.data['img']).delete();
          }
        ...
        await service.doc(widget.docID).update({
